...
public class OpeningHourDefaultService {
    ...
    public OpeningHourDefaultCompleteResponseDTO createOpeningHourDefault(
        ...
        // todo: validamos si no están ya creados, si los tenemos mandamos el path.
        // todo: debería valer con mandarle un exists con el id del restaurante
        validateHours(openingHourDefaultCompleteRequestDTO);
    ...
    private void validateHours(OpeningHourDefaultCompleteRequestDTO dto) {
        dto.getOpeningHoursDefault().forEach(this::validateDay);
    }

    private void validateDay(OpeningHourDefaultRequestDTO dayDto) {
        if (dayDto != null) {
